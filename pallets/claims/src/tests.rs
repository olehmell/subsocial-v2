...
#[test]
fn claim_tokens_should_fail_when_the_account_already_claimed() {
    ExtBuilder::build_with_account1_as_rewards_account_and_eligible_accounts().execute_with(|| {
        assert_ok!(_claim_tokens_to_account2());
...
// set_rewards_sender
#[test]
fn set_rewards_sender_should_be_work() {
    ExtBuilder::build().execute_with(|| {
...
//
#[test]
fn add_eligible_accounts_should_be_work() {
    ExtBuilder::build().execute_with(|| {
...
#[test]
fn add_eligible_accounts_should_fail_when_try_add_many_accounts() {
    ExtBuilder::build().execute_with(|| {
